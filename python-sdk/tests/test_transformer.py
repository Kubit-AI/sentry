...
#
# Each class below pins one representative span shape emitted by a specific
# instrumentation framework, verified against research reports. Failures here
# indicate wire-format drift that would cause silent data loss in production.
